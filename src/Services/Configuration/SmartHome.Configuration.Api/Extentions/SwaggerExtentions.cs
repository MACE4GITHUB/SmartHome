...
namespace SmartHome.Configuration.Api.Extentions
{
    ...
    {
        /// <summary>
        /// Adds Swagger with base description Web API for the site SmartHome Configuration.
        /// </summary>
        ...
        public static IServiceCollection AddSwagger(this IServiceCollection services)
        {
            ...
            services
                ...
                .Configure(options =>
                {
                    ...
                    {
                        Version = "v1",
                        Title = "SmartHome Configuration API",
                        Description = "Web API for the SmartHome Configuration.",
            ...
            services
                ...
                .Configure(options => options.SwaggerEndpoint("/swagger/v1/swagger.json", "SmartHome Configuration WebApi v1"));
